...
def run_agent(question):
    ...
    for step in range(5): #range depends on how many steps you want to run the agent for
        ...
        # Find the Action
        match = re.search(
            r"Action:\s*(\w+)\((.*?)\)",  #this line is a regular expression to find the tool name and input
            answer
        )
        ...
        if match:
            ...
            sleep(5) #useful to avoid rate limits, you can remove it if you want
